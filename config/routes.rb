Rails.application.routes.draw do
  ...
  #post '/applications/create', to: 'apps#get_token'
   ...
   namespace 'v1' do
       ...
       get '/applications/:app_token/chats_count', to: 'apps#get_chats_count'
       ...
       get '/applications/:app_token/chats/:chat_number/messages_count', to: 'chats#get_messages_count'
       ...
       get '/applications/:app_token/chats/:chat_number/messages/:message_number', to: 'messages#get_message'
